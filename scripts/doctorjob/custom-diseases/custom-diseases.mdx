...
<Warning>
  This section is for advanced users. In this guide I will **not** teach you how
  to code. The guide contains all the necessary information for an experienced
  user to start implementing custom diseases within the Doctorjob Script.
</Warning>
